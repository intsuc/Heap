...
data remove storage heaps: _[{s: 0b}]._[{s: 0b}]._[].s
execute unless data storage heaps: _[{s: 0b}]._[{s: 0b}]._ run data modify storage heaps: _[{s: 0b}]._[{s: 0b}]._ set from storage heaps.immutable: node
