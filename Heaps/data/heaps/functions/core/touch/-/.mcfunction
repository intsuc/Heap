...
execute store result score heaps:addr heaps run data get storage heaps._: in.addr 0.000244140625
...
execute store result score heaps:addr heaps run data get storage heaps._: in.addr 0.00390625
...
execute store result score heaps:addr heaps run data get storage heaps._: in.addr 0.0625
scoreboard players operation heaps:addr heaps %= heaps:node_size heaps
