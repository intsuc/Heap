#> heaps:core/dealloc/weak/s/4/
#
# @within heaps:api/dealloc/weak/s/4
#
# @input
#   storage heaps: in
#       addr: int
...
data modify storage heaps.free: ""[-3].out[-1][1] set from storage heaps.vector: _[{s: 0b}]._[{s: 0b}]._[{s: 0b}]._[{s: 0b}].size
