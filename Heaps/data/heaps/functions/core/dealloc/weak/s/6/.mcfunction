#> heaps:core/dealloc/weak/s/6/
#
# @within heaps:api/dealloc/weak/s/6
#
# @input
#   storage heaps: in
#       addr: int

function heaps:core/touch/s/6/
...
data modify storage heaps.free: ""[-3].out[-1][1] set from storage heaps.vector: _[{s: 0b}]._[{s: 0b}]._[{s: 0b}]._[{s: 0b}]._[{s: 0b}]._[{s: 0b}].size
data remove storage heaps.vector: _[{s: 0b}]._[{s: 0b}]._[{s: 0b}]._[{s: 0b}]._[{s: 0b}]._[{s: 0b}].size
