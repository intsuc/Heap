...
execute store result score heap:addr heap run data get storage heap._: in.addr 0.0001286008230452675
...
execute store result score heap:addr heap run data get storage heap._: in.addr 0.0007716049382716049
...
execute store result score heap:addr heap run data get storage heap._: in.addr 0.004629629629629629
scoreboard players operation heap:addr heap %= heap:node_size heap
...
execute store result score heap:addr heap run data get storage heap._: in.addr 0.027777777777777776
scoreboard players operation heap:addr heap %= heap:node_size heap
...
execute store result score heap:addr heap run data get storage heap._: in.addr 0.16666666666666666
scoreboard players operation heap:addr heap %= heap:node_size heap
execute store result score heap:cache heap run data get storage heap: cache[4] 1.0
execute unless score heap:addr heap = heap:cache heap run function heap:core/touch/-/4
...
execute unless score heap:addr heap = heap:cache heap run function heap:core/touch/-/5
