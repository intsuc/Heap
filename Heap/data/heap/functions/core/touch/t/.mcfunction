...
execute unless score heap:ptr heap = heap:cache heap run function heap:core/touch/t/0

execute store result score heap:cache heap run data get storage heap: cache[13] 1.0
execute unless score heap:ptr heap = heap:cache heap run function heap:core/touch/t/1

execute store result score heap:cache heap run data get storage heap: cache[14] 1.0
execute unless score heap:ptr heap = heap:cache heap run function heap:core/touch/t/2

execute store result score heap:cache heap run data get storage heap: cache[15] 1.0
execute unless score heap:ptr heap = heap:cache heap run function heap:core/touch/t/3

execute store result score heap:cache heap run data get storage heap: cache[16] 1.0
execute unless score heap:ptr heap = heap:cache heap run function heap:core/touch/t/4

execute store result score heap:cache heap run data get storage heap: cache[17] 1.0
execute unless score heap:ptr heap = heap:cache heap run function heap:core/touch/t/5
