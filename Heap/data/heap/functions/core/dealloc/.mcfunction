...
execute store result score heap:addr_top heap store result score heap:end_top heap run data get storage heap.free: out[-1][0] 1.0
execute store result score heap:size_top heap run data get storage heap.free: out[-1][1] 1.0
...
execute if score heap:end_top heap = heap:addr heap store result storage heap.free: out[-1][1] int 1.0 run scoreboard players operation heap:size heap += heap:size_top heap
