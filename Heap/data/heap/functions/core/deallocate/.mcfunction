...
# Retrun the cell to the free ring.
  ...
  data modify storage heap.free_ring: ""[-1][1] set from storage heap: _[{i: 0b}]._[{i: 0b}]._[{i: 0b}]._[{i: 0b}]._[{i: 0b}]._[{i: 0b}]._.size

function heap:core/free_ring/increment

# Cancel out `link` and `unlink`.
  data modify storage heap.collector: link append from storage heap: _[{i: 0b}]._[{i: 0b}]._[{i: 0b}]._[{i: 0b}]._[{i: 0b}]._[{i: 0b}]._.unlink[]
  data modify storage heap.collector: unlink append from storage heap: _[{i: 0b}]._[{i: 0b}]._[{i: 0b}]._[{i: 0b}]._[{i: 0b}]._[{i: 0b}]._.link[]
