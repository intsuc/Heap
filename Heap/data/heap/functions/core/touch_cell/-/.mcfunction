...
execute unless score heap:ptr heap = heap:cache heap run function heap:core/touch_cell/-/0
...
execute unless score heap:ptr heap = heap:cache heap run function heap:core/touch_cell/-/1
...
execute unless score heap:ptr heap = heap:cache heap run function heap:core/touch_cell/-/2
...
execute unless score heap:ptr heap = heap:cache heap run function heap:core/touch_cell/-/3
...
execute unless score heap:ptr heap = heap:cache heap run function heap:core/touch_cell/-/4
...
execute unless score heap:ptr heap = heap:cache heap run function heap:core/touch_cell/-/5
